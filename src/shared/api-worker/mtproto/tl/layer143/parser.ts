...
const _chatFull = (): any => {
  ...
  if (flags & 0x40000) result.available_reactions = vector(str);
  return result;
};
const _channelFull = (): any => {
  ...
  if (flags & 0x40000000) result.available_reactions = vector(str);
  return result;
};
...
const _updatePeerBlocked: any = () => ({ _: 'updatePeerBlocked', _update: true, peer_id: obj(), blocked: obj() });
...
const _updateMessageReactions: any = () => ({ _: 'updateMessageReactions', _update: true, peer: obj(), msg_id: i32(), reactions: obj() });
...
const _invoice = (): any => {
  ...
  if (flags & 0x200) result.recurring_terms_url = str();
  return result;
};
...
const _channelAdminLogEventActionChangeAvailableReactions: any = () => ({ _: 'channelAdminLogEventActionChangeAvailableReactions', prev_value: vector(str), new_value: vector(str) });
...
const _globalPrivacySettings = (): any => {
  ...
  const flags = i32();
  if (flags & 0x1) result.archive_and_mute_new_noncontact_peers = obj();
  return result;
};
...
const _messagesTranslateNoResult: any = () => ({ _: 'messages.translateNoResult' });
const _messagesTranslateResultText: any = () => ({ _: 'messages.translateResultText', text: str() });
...
const _helpPremiumPromo: any = () => ({ _: 'help.premiumPromo', status_text: str(), status_entities: vector(obj), video_sections: vector(str), videos: vector(obj), currency: str(), monthly_amount: i64(), users: vector(obj) });
...
const parserMap = new Map<number, () => any>([
  ...
  [0xc642724e, _inputChatUploadedPhoto],
  ...
  [0xd18ee226, _chatFull],
  [0xea68a619, _channelFull],
  ...
  [0xdf1f002b, _inputPeerNotifySettings],
  [0xa83b0426, _peerNotifySettings],
  ...
  [0x154798c3, _updateMessageReactions],
  ...
  [0xb0133b37, _paymentsPaymentForm],
  ...
  [0x9cf7f76a, _channelAdminLogEventActionChangeAvailableReactions],
  ...
  [0x8a6469c2, _codeSettings],
  [0x1dc1bca4, _wallPaperSettings],
  [0x8efab953, _autoDownloadSettings],
  ...
  [0x67ca4737, _messagesTranslateNoResult],
  [0xa214f7d0, _messagesTranslateResultText],
  [0x51b67eff, _messagePeerReaction],
...
function vector(t: () => any, bare = false) {
  ...
  const len = i32();
  const result = [];
  for (let i = 0; i < len; ++i) result.push((t as () => never)());
  return result;
}

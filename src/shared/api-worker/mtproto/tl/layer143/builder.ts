...
/* the tool instead.                                                                       */
/*                                                                                         */
/* Source: layer143.json (md5: 39f09ec14de8896148148f420a3b084f)                           */
/* Time: Friday, 01 July 2022 11:21:28 (UTC)                                               */
/*                                                                                         */
/*******************************************************************************************/
...
const _chatFull = (o: any) => {
  ...
  flagVector(str, o.available_reactions);
};
...
const _messagesTranslateResultText = (o: any) => {
  str(o.text);
};
...
const _messagesSetChatAvailableReactions = (o: any) => {
  obj(o.peer);
  vector(str, o.available_reactions);
};
...
const _paymentsAssignPlayMarketTransaction = (o: any) => {
  str(o.purchase_token);
};

const _paymentsRestorePlayMarketReceipt = (o: any) => {
  bytes(o.receipt);
};

const _paymentsRequestRecurringPayment = (o: any) => {
  obj(o.user_id);
  str(o.recurring_init_charge);
  obj(o.invoice_media);
};
...
const builderMap: Record<string, [number, ((o: any) => void)?]> = {
  ...
  'chatFull': [0xd18ee226, _chatFull],
  'channelFull': [0xea68a619, _channelFull],
  ...
  'auth.authorization': [0x33fb7bb8, _authAuthorization],
  ...
  'inputPeerNotifySettings': [0xdf1f002b, _inputPeerNotifySettings],
  'peerNotifySettings': [0xa83b0426, _peerNotifySettings],
  ...
  'updateMessageReactions': [0x154798c3, _updateMessageReactions],
  ...
  'chatInvite': [0x300c44c1, _chatInvite],
  ...
  'payments.paymentForm': [0xb0133b37, _paymentsPaymentForm],
  ...
  'channelAdminLogEventActionChangeAvailableReactions': [0x9cf7f76a, _channelAdminLogEventActionChangeAvailableReactions],
  ...
  'codeSettings': [0x8a6469c2, _codeSettings],
  'wallPaperSettings': [0x1dc1bca4, _wallPaperSettings],
  'autoDownloadSettings': [0x8efab953, _autoDownloadSettings],
  ...
  'sponsoredMessage': [0x3a836df8, _sponsoredMessage],
  ...
  'channels.sendAsPeers': [0x8356cda9, _channelsSendAsPeers],
  ...
  'reactionCount': [0x6fb250d1, _reactionCount],
  ...
  'messages.translateNoResult': [0x67ca4737],
  'messages.translateResultText': [0xa214f7d0, _messagesTranslateResultText],
  'messagePeerReaction': [0x51b67eff, _messagePeerReaction],
  ...
  'attachMenuBot': [0xc8aa2cd2, _attachMenuBot],
  ...
  'help.premiumPromo': [0x8a4f3c29, _helpPremiumPromo],
  ...
  'messages.sendMessage': [0xd9d75a4, _messagesSendMessage],
  'messages.sendMedia': [0xe25ff8e0, _messagesSendMedia],
  'messages.forwardMessages': [0xcc30290b, _messagesForwardMessages],
  ...
  'messages.sendInlineBotResult': [0x7aa11297, _messagesSendInlineBotResult],
  ...
  'messages.sendMultiMedia': [0xf803138f, _messagesSendMultiMedia],
  ...
  'messages.sendReaction': [0x25690ce4, _messagesSendReaction],
  'messages.getMessagesReactions': [0x8bba90e6, _messagesGetMessagesReactions],
  'messages.getMessageReactionsList': [0xe0ee6b77, _messagesGetMessageReactionsList],
  'messages.setChatAvailableReactions': [0x14050ea6, _messagesSetChatAvailableReactions],
  'messages.getAvailableReactions': [0x18dea0ac, _messagesGetAvailableReactions],
  'messages.setDefaultReaction': [0xd960c4d4, _messagesSetDefaultReaction],
  'messages.translateText': [0x24ce6dee, _messagesTranslateText],
  'messages.getUnreadReactions': [0xe85bae1a, _messagesGetUnreadReactions],
  'messages.readReactions': [0x82e251d7, _messagesReadReactions],
  ...
  'messages.toggleBotInAttachMenu': [0x1aee33af, _messagesToggleBotInAttachMenu],
  'messages.requestWebView': [0x91b15831, _messagesRequestWebView],
  'messages.prolongWebView': [0xea5fbcce, _messagesProlongWebView],
  'messages.requestSimpleWebView': [0x6abb2f73, _messagesRequestSimpleWebView],
  ...
  'payments.assignAppStoreTransaction': [0xfec13c6, _paymentsAssignAppStoreTransaction],
  'payments.assignPlayMarketTransaction': [0x4faa4aed, _paymentsAssignPlayMarketTransaction],
  'payments.restorePlayMarketReceipt': [0xd164e36a, _paymentsRestorePlayMarketReceipt],
  'payments.canPurchasePremium': [0xaa6a90c8],
  'payments.requestRecurringPayment': [0x146e958d, _paymentsRequestRecurringPayment],
